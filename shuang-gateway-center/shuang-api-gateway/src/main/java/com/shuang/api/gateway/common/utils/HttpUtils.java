package com.shuang.api.gateway.common.utils;
...
public class HttpUtils {
    ...
    public static void setAttributeByCommonParm(ServerWebExchange exchange, JSONObject object) {
        exchange.getAttributes().put(Constants.shuangAPIGATEWAYBODYPARAM, object);
    }
    ...
    public static Object getCommonParm(ServerWebExchange exchange, String parmStr) {
        ...
        if ("POST".equalsIgnoreCase(method)) {
            Object object = exchange.getAttributes().get(Constants.shuangAPIGATEWAYBODYPARAM);
