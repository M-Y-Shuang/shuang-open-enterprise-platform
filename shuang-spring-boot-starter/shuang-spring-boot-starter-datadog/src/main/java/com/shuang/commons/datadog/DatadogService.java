package com.shuang.commons.datadog;
...
public class DatadogService implements StatsD {
	...
	@Value("${shuang.setting.datadog.agent.prefix:shuang}")
	private String datadogAgentPrefix;

	@Value("${shuang.setting.datadog.agent.host:localhost}")
	private String datadogAgentHost;

	@Value("${shuang.setting.datadog.agent.port:8125}")
