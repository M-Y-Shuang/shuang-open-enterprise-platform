package com.shuang.mybatis.generator.plugins;

import com.shuang.mybatis.generator.plugins.annotation.Annotation;
import com.shuang.mybatis.generator.plugins.annotation.ImportAnnotation;
import com.shuang.mybatis.generator.plugins.custom.CustomAbstractXmlElementGenerator;
import com.shuang.mybatis.generator.plugins.custom.CustomJavaMapperMethodGenerator;
...
public class BasePlugin extends PluginAdapter {
    ...
    private void setBaseMapper(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable){
        ...
        FullyQualifiedJavaType imp = new FullyQualifiedJavaType("com.shuang.commons.support.base.BaseMapper");
