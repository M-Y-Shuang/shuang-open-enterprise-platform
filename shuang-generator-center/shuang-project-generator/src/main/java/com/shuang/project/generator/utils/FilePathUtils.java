package com.shuang.project.generator.utils;
...
public class FilePathUtils {
     ...
     * 通过 项目名称 生成包
     * projectName 项目名称
     * 如：shuang-file-uoplod ----》com/shuang/file/uoplod/
     */
     ...
     * 通过 项目名称 生成主类名称
     * projectName 项目名称
     * 如：shuang-file-uoplod ----》FileUpload
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：shuang-file-upload ----》shuang.file.upload
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：shuang-file-upload ----》file-upload-server
     */
     ...
     * 通过 项目名称 生成 包名
     * projectName 项目名称
     * 如：shuang-file-upload ----》file-upload
     */
    ...
    public static void main(String[] args) throws Exception{
        System.out.println(getPackPath("shuang-file-uoplod"));
        System.out.println(getClassName("shuang-file-uoplod"));
        System.out.println(getClassNameFirst("shuang-file-uoplod"));
        System.out.println(getServerId("shuang-file-uoplod"));
    }
}
