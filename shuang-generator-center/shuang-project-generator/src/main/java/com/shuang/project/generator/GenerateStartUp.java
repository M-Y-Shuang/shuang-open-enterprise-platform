package com.shuang.project.generator;

import com.shuang.project.generator.simple.SimpleProjectGenerateUtil;
import com.shuang.project.generator.standard.bean.BeanProjectGenerateUtil;
import com.shuang.project.generator.standard.common.CommonProjectGenerateUtil;
import com.shuang.project.generator.standard.core.CoreProjectGenerateUtil;
import com.shuang.project.generator.standard.parent.ParentProjectGenerateUtil;
import com.shuang.project.generator.standard.rest.RestProjectGenerateUtil;
import com.shuang.project.generator.standard.sdk.SdkProjectGenerateUtil;
...
public class GenerateStartUp {
    ...
    //项目名称
    public final static String projectName = "shuang-user";
    //项目说明
