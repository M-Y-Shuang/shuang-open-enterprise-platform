package com.shuang.commons.multi.jpa.annotation.config;
...
@EnableJpaRepositories(value = "com.shuang.commons.multi.jpa.annotation.repository",
...
public class JpaEntityManager {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages("com.shuang.commons.multi.jpa.annotation.model")
